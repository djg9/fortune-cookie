...
let fortunes = ['You will reconnect with an old friend', 'You will eat some food', 'An unexpected twist of fate lies ahead', 'Smooth sailing ahead', 'You will sleep tonight'];
